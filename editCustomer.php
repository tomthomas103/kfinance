	...
	<div class="page-header">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="fa fa-th-large position-left"></i>Edit Customer Details </h4>
			</div>										
			<ul class="breadcrumb">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="panel panel-flat">
					...
					<?php
						...
						$obj=new dboperation();
						$query1="SELECT c.cust_id,c.cust_name,c.cust_housename,s.amount_given,s.stock_date,s.status FROM tbl_customer as c inner join tbl_stock as s WHERE c.cust_id=s.cust_id";
					...
					<table class="table datatable datatable-column-search-inputs" id="">
						...
						<?php
							...
							echo "<tr>
								...
								<td>
									<h6 class='no-margin'>
										<a href='editCustomerViewAction.php?&id=$r1[0]'>$r1[1]</a>
									</h6>
								</td>								
								<td>
									$r1[2]
