...
function calctot()
{
	...
	var cur_amt=parseInt(document.getElementById("cur_amt").value);
    var new_amt=parseInt(document.getElementById("new_amt").value);
	document.getElementById("tot_amt").value=cur_amt+new_amt;
}
	</script>
</head>
	...
	<div class="page-header">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="fa fa-pencil position-left"></i> Credit More Amount</h4>
			</div>										
			<ul class="breadcrumb">
...
<div class="panel panel-flat">
			<form class="form-validation" action="add_amt_action.php" method="post">
				<fieldset class="step" id="validation-step1">
					<div class="row">
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								<label>Customer Name:</label>
								<input type="text" name="cust_name" class="form-control" value="<?php echo $f2[0]; ?>" readonly>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								...
								<input type="text" name="cur_amt"  id="cur_amt" value="<?php echo $newp; ?>" class="form-control" readonly>
							</div>
						</div>
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								...
								<input type="date" name="sd" class="form-control" value="<?php echo date('Y-m-d')?>"  />
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								...
								<input type="number" id="new_amt" name="new_amt" id="t_amt" class="form-control">
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								...
								<input type="text" name="tot_amt"  id="tot_amt" onFocus="calctot()" class="form-control" >
							</div>
						</div>
			...
			<div class="modal-dialog">
				<div class="modal-content bg-danger">
					<div class="modal-header">
						...
						<h4 class="modal-title">Do you really want to Credit this account</h4>
					</div>
