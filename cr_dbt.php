	...
	<div class="page-header">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="fa fa-pencil position-left"></i> Credit/debit Amount</h4>
			</div>										
...
<div class="panel panel-flat">
			<form class="form-validation" action="cre_debt_amt.php" method="post">
				<fieldset class="step" id="validation-step1">
					<div class="row">
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								<label>Date</label>
								<input type="date" name="cddate" class="form-control"value="<?php echo date('Y-m-d')?>" class="form-control">
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								<label>Current Credit/Debit Amount :</label>
								<input type="text" name="cre_debt_amt"  id="cur_amt"  class="form-control">
							</div>
						</div>
					...
					<div class="col-md-6 col-sm-6">
							<div class="form-group">
								<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal_theme_danger">Credit/Debit</button>
			...
			<div class="modal-dialog">
				<div class="modal-content bg-danger">
					<div class="modal-header">
						...
						<h4 class="modal-title">Do you really want to Credit/Debit this account</h4>
					</div>
