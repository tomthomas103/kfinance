			...
			<div class="col-lg-9 col-sm-8">
				...
				<div class="panel panel-flat">
					...
					<div class="panel-body">
                        ...
                        <tr>
                        <td>
						<form action="add_amt.php?&amp;cust_id=<?php echo $cust_id;?>&amp;i=<?php echo $in;?>" method="post">
							<button type="submit" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="fa fa-hand-o-right"></i></b> Credit more Amount</button>
						</form>
                        </td>
                        <td>&nbsp;</td>
                        <td>
						<form action="gold_release.php?&amp;stock_id=<?php echo $stock_id;?>&amp;cust_id=<?php echo $cust_id;?>&amp;amt=<?php echo $newp; ?>" method="post" align>
							<button type="button" class="btn bg-teal-400 btn-labeled btn-rounded" data-toggle="modal" data-target="#modal_theme_danger"><b><i class="fa fa-hand-o-right"></i></b> Release Gold</button>
							<!-- Danger modal -->
			...
			<div class="modal-dialog">
				<div class="modal-content bg-danger">
					<div class="modal-header">
						...
						<h4 class="modal-title">Do you really want to Release Gold</h4>
					</div>
